...
exports.fetchMeal = exports.MealType = undefined;
...
var MealType = exports.MealType = {
  BREAKFAST: 0,
  LUNCH: 1,
  DINNER: 2
};

var fetchMeal = exports.fetchMeal = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(date) {
    var mealType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : MealType.LUNCH;
